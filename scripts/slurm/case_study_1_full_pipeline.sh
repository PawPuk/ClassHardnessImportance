...
do
    ...
    do
        ...
        do
            ...
            job_name="${dataset_code}clp${pruning_rate}"
...
do
    ...
    sbatch --dependency=afterok:$case_dependency --job-name="$job_name" --output="$log_file" scripts/slurm/visualize_case_study_1_results.sh "$dataset_name"

    baseline_job_ids+=($jid)
done

python -m src.experiments.visualize_case_study_1_results --dataset_name CIFAR100
