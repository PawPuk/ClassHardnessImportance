...
# python -m src.experiments.case_study_1 --dataset_name CIFAR100 --pruning_rate 33 --oversampling_strategy holdout
python -m src.experiments.case_study_1 --dataset_name CIFAR100 --pruning_rate 42 --oversampling_strategy holdout
#python -m src.experiments.case_study_1 --dataset_name CIFAR100 --pruning_rate 50 --oversampling_strategy holdout
python -m src.experiments.case_study_1 --dataset_name CIFAR100 --pruning_rate 58 --oversampling_strategy holdout
# python -m src.experiments.case_study_1 --dataset_name CIFAR100 --pruning_rate 66 --oversampling_strategy holdout
#python -m src.experiments.case_study_1 --dataset_name CIFAR100 --pruning_rate 75 --oversampling_strategy holdout
