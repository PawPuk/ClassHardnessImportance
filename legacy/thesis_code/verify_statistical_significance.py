...
from src.data.data import AugmentedSubset, load_dataset
from src.models.neural_networks import ResNet18LowRes
from src.utils.utils import compute_sample_allocation_after_resampling, load_hardness_estimates
...
class Visualizer:
    ...
    def get_pruned_indices(self, hardness_estimates: Dict[Tuple[int, int], Dict[str, List[float]]]
        ...
        restructured_hardness_estimates = self.restructure_hardness_dictionary(hardness_estimates)
